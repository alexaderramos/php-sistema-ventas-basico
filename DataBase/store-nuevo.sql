...
-- Tiempo de generación: 22-11-2020 a las 21:15:54
...
('C1', 'Electrodomesticos', 'Articulos de primera necesidad para el hogar'),
...
CREATE TABLE `metodo_pago` (
  ...
  `expira` varchar(50) NOT NULL DEFAULT '',
  `cvc` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
ALTER TABLE `metodo_pago`
  ADD CONSTRAINT `FK_venta_id` FOREIGN KEY (`venta_id`) REFERENCES `venta` (`NumPedido`);
